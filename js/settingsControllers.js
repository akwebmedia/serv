 ...
 */
angular.module('starter.controllers').controller('SettingsCtrl', function($scope, $rootScope, database, $localstorage, Utils, $state, applicationServices, $timeout, pendingTicketUploadProcess) {
